...
import cc.alcina.framework.gwt.client.objecttree.basic.CriteriaGroupRenderer;
import cc.alcina.template.cs.misc.search.UserCriteriaGroup;
...
public class UserCriteriaGroupRenderer extends
	...
	public RenderInstruction renderInstruction() {
		return getRenderable().isRestrictToCurrentUser() ? RenderInstruction.NO_RENDER
				: super.renderInstruction();
	}
}
