...
@Registration({ ContentDeliveryType.class, ContentDeliveryType_DOWNLOAD_ATTACHMENT.class })
public class ContentDeliveryDownloadAsAttachment implements ContentDelivery {
    ...
    protected String deliverViaServlet(InputStream stream, String mimeType, String suggestedFileName, String suffix) throws Exception {
        ...
        DownloadItem item = new DownloadServlet.DownloadItem(mimeType, suggestedFileName + "." + suffix, file.getPath());
