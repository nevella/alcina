...
public abstract class AbstractTaskPerformer implements Runnable, Task, TaskPerformer {
	 ...
	 */
    public <T extends AbstractTaskPerformer> T withTypedValue(Object typedValue) {
    ...
    protected <T> T typedValue(Class<T> clazz) {
        try {
            ...
            try {
                logger.warn("Typed value invalid - class {}. \nValid sample:\n{}", clazz.getName(), JacksonUtils.serializeWithDefaultsAndTypes(clazz.getDeclaredConstructor().newInstance()));
                return null;
            } catch (Exception e2) {
