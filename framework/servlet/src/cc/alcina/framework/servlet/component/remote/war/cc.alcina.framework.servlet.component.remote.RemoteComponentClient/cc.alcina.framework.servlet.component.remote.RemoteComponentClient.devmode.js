...
var __gwtModuleFunction = $wnd.cc_alcina_framework_servlet_component_remote_RemoteComponentClient;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.cc.alcina.framework.servlet.component.remote.RemoteComponentClient=");
    idx += (13 + "cc.alcina.framework.servlet.component.remote.RemoteComponentClient".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=cc.alcina.framework.servlet.component.remote.RemoteComponentClient-0.js
