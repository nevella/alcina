...
var __gwtModuleFunction = $wnd.cc_alcina_framework_servlet_component_test_AlcinaGwtTestClient;
...
function getCodeServer() {
	...
	if (idx >= 0) {
		...
		idx = query.indexOf("gwt.codesvr.cc.alcina.framework.servlet.component.test.AlcinaGwtTestClient=");
		idx += (13 + "cc.alcina.framework.servlet.component.test.AlcinaGwtTestClient".length);  // 
	}
	if (idx >= 0) {
...
//# sourceURL=cc.alcina.framework.servlet.component.test.AlcinaGwtTestClient-0.js
