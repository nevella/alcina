...
function getCodeServer() {
	...
	if (idx >= 0) {
		...
		idx = query.indexOf("gwt.codesvr.cc.alcina.framework.servlet.component.romcom.RemoteObjectModelComponentClient=");
		idx += (13 + "cc.alcina.framework.servlet.component.romcom.RemoteObjectModelComponentClient".length);  // 
	}
	if (idx >= 0) {
