...
public class ClientPropertiesUtil {
	...
	public String generateCookie() {
		return UrlComponentEncoder.get().encode(cookieMap.toPropertyString());
	}
	 ...
	 * <li>Cookie must be set on a response to the client in order to persist
	 * the property.
	 * 
	 * @param propertyLocation
	 *            Class marker on which the property should be registered
	 * @param propertyName
	 *            Property name
	 * @param value
	 *            Boolean value to set on the property
	 * @return New cookie value
	 */
	public void setOnCookie(Class propertyLocation, String propertyName,
			boolean value) {
