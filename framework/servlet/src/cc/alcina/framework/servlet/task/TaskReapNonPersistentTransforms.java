...
import cc.alcina.framework.entity.entityaccess.cache.DataSourceAdapter;
import cc.alcina.framework.entity.entityaccess.cache.DomainStore;
import cc.alcina.framework.entity.entityaccess.cache.mvcc.Transaction;
import cc.alcina.framework.entity.entityaccess.updater.LocalDbPropertyBase;
	...
	protected void reap() throws Exception {
		...
		try {
			...
			while (true) {
				...
				Transaction.commit();
				Transaction.endAndBeginNew();
				JobRegistry.get().checkCancelled();
				if (lastId > maxId) {
