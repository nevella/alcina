...
@RegistryLocation(registryPoint = ScheduleProvider.class, targetClass = AppHourlies.class, implementationType = ImplementationType.INSTANCE)
public class ScheduleProviderAppHourlies implements ScheduleProvider {
	@Override
