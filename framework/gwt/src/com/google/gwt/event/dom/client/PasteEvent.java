...
public class PasteEvent extends DomEvent<PasteHandler> {
	/**
	 * Event type for paste events. Represents the meta-data associated with
	 * this event.
	 */
	private static final Type<PasteHandler> TYPE = new Type<PasteHandler>(
			BrowserEvents.PASTE, new PasteEvent());
