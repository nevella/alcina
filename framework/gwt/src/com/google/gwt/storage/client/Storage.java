 ...
 *      Storage</a>
 * @see <a href=
 *      "http://devworld.apple.com/safari/library/documentation/iPhone/Conceptual/SafariJSDatabaseGuide/Name-ValueStorage/Name-ValueStorage.html">Safari
 ...
 * @see <a href=
 *      "http://code.google.com/p/gwt-mobile-webkit/wiki/StorageApi">Wiki -
 *      Quickstart Guide</a>
 */
...
public final class Storage {
	// Still a separate class to prevent native calls on class load as it my
	// break existing code.
	private static class StorageSupportDetector {
		static final boolean localStorageSupported = checkStorageSupport(
				StorageImpl.LOCAL_STORAGE);

		static final boolean sessionStorageSupported = checkStorageSupport(
				StorageImpl.SESSION_STORAGE);
	 ...
	 *
	 * <p>
	 * The returned storage is associated with the
	 * <a href="http://www.w3.org/TR/html5/browsers.html#origin">origin</a> of
	 * the Document.
	 * </p>
	 *
	 ...
	 * </p>
	 *
	 * @see <a href="http://www.w3.org/TR/webstorage/#dom-sessionstorage">W3C
	 *      Web Storage - sessionStorage</a>
	 * @return the sessionStorage instance, or <code>null</code> if Web Storage
	 *         is NOT supported.
	 */
	...
	public static boolean isLocalStorageSupported() {
		return Al.isBrowser() && StorageSupportDetector.localStorageSupported;
	}
	 ...
	 *            the key to a value in the Storage
	 * @see <a href=
	 *      "http://www.w3.org/TR/webstorage/#dom-storage-removeitem">W3C Web
	 *      Storage - Storage.removeItem(k)</a>
	 */
