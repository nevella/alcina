 ...
 * 
 * Here because (although identical to GWT 2.8.0 rc3 source), there were some
 * compiler/datestamp issues. Newer forces this
 */
public class ColumnSortEvent extends GwtEvent<ColumnSortEvent.Handler> {
	 ...
	 * @param sortList
	 *            the {@link ColumnSortList} of sorted columns
	 ...
	 * such as {@link com.google.gwt.view.client.AsyncDataProvider
	 * AsyncDataProvider}. This handler calls
	 * {@link HasData#setVisibleRangeAndClearData(com.google.gwt.view.client.Range, boolean)},
	 * which clears the current data and triggers the data provider's range
	 * change handler.
	 */
	public static class AsyncHandler implements Handler {
		...
		public void onColumnSort(ColumnSortEvent event) {
			hasData.setVisibleRangeAndClearData(hasData.getVisibleRange(),
					true);
		}
	}
	...
	public static interface Handler extends EventHandler {
		 ...
		 * 
		 * @param event
		 *            the {@link ColumnSortEvent} that was fired
		 */
	...
	public static class ListHandler<T> implements Handler {
		...
		/**
		 * Set the comparator used to sort the specified column in ascending
		 * order.
		 * 
		 * @param column
		 *            the {@link Column}
