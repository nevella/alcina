...
public class Label extends LabelBase<String>
		implements HasDirectionalText, HasDirection, HasClickHandlers,
		HasDoubleClickHandlers, SourcesClickEvents, SourcesMouseEvents,
		HasAllDragAndDropHandlers, HasAllGestureHandlers, HasAllMouseHandlers,
	 ...
	 *             {@link #addMouseUpHandler} and {@link #addMouseOutHandler}
	 *             instead
	 */
	@Override
	@Deprecated
	 ...
	 * directionEstimator} is null. Otherwise, the widget's direction is set
	 * using the estimator, and its alignment may therefore change as described
	 * in
	 ...
	 * start or end edge, respectively, of the new direction (the {@code dir}
	 ...
	 * widget element is a &lt;div&gt; and has no explicit alignment value even
	 * by inheritance.
	 * </ul>
	 *
	 * @param text
