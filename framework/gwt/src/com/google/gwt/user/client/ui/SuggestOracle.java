...
public abstract class SuggestOracle {
	 ...
	 * must be null as it represents the results the oracle should return based
	 * on no query string.
	 * <p>
	 ...
	 * called after a {@link Response} is generated.
	 */
	...
	public static class Response extends Bindable implements IsSerializable {
		 ...
		 */
		public void
				setSuggestions(Collection<? extends Suggestion> suggestions) {
	 ...
	 * {@link com.google.gwt.user.client.ui.SuggestOracle}. Each suggestion has
	 * a display string and a replacement string. The display string is what is
	 ...
	 * the employee, a SuggestBox is used to provide name suggestions as the
	 * user types. When the user types the letter <i>f</i>, a suggestion with
	 * the display string <i>foo bar</i> appears. When the user chooses this
	 ...
	 * a suggestion exactly matches the input data format, the
	 ...
	 * returned with the suggestion may provide additional contact information
	 * about the selected employee, and this information could be used to fill
	 * out other fields on the form. To send back a DTO with each suggestion,
	 ...
	 * SuggestBox (see SuggestBox's documentation for more information). In the
	 ...
	 * {@link com.google.gwt.event.logical.shared.SelectionEvent} object, and
	 * downcast the <code>Suggestion</code> object to the subinterface. Then,
	 * access the DTO using the DTO getter method that was defined on the
	 * subinterface.
	 * </p>
	 */
