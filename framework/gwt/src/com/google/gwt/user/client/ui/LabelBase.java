...
public class LabelBase<T> extends Widget implements HasWordWrap,
	 ...
	 * 
	 * <p>
	 * Note: A subsequent call to {@link #setAutoHorizontalAlignment} may
	 * override the horizontal alignment set by this method.
	 * <p>
	 * Note: For {@code null}, the horizontal alignment is cleared, allowing it
	 * to be determined by the standard HTML mechanisms such as inheritance and
	 * CSS rules.
	 * 
	 ...
	 * AutoHorizontalAlignment setting. Should be invoked whenever the
	 * horizontal alignment may be affected, i.e. on every modification of the
	 * content or its direction.
	 */
		...
		if (autoHorizontalAlignment == null) {
			...
			align = autoHorizontalAlignment == ALIGN_CONTENT_START
					? HorizontalAlignmentConstant
							.startOf(directionalTextHelper.getTextDirection())
					: HorizontalAlignmentConstant
