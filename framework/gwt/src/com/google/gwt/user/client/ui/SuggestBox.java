...
public class SuggestBox extends Composite
		...
		FiresSuggestionEvents, HasAllKeyHandlers, HasValue<String>,
	...
	public static class DefaultSuggestionDisplay extends SuggestionDisplay
		...
		protected PopupPanel suggestionPopup;
		 ...
		 * autoHide partner.
		 */
		protected SuggestBox lastSuggestBox = null;
		...
		protected void createSuggestionMenu() {
	...
	public HandlerRegistration
			addSelectionHandler(SelectionHandler<Suggestion> handler) {
	...
	/**
	 * @deprecated Use the {@link HandlerRegistration#removeHandler} method no
	 *             the object returned by {@link #addSelectionHandler} instead
	 */
	@Deprecated
