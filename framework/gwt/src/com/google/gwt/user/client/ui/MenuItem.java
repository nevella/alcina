...
/**
 * An entry in a {@link com.google.gwt.user.client.ui.MenuBar}. Menu items can
 * either fire a {@link com.google.gwt.core.client.Scheduler.ScheduledCommand}
 * when they are clicked, or open a cascading sub-menu.
 *
...
public class MenuItem extends UIObject
	...
	public void setSubMenu(MenuBar subMenu) {
		...
		if (subMenu != null) {
			...
			// Update a11y role "haspopup"
			Roles.getMenuitemRole().setAriaHaspopupProperty(getElement(),
					false);
		}
	}
