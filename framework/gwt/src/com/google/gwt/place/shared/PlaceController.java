...
public class PlaceController {
	private static final Logger log = Logger
			.getLogger(PlaceController.class.getName());
	...
	public void goTo(Place newPlace) {
		...
		if (willChange.getCancelled() != null) {
			delegate.cancelled(willChange.getCancelled());
			return;
		}
	...
	public static class DefaultDelegate implements Delegate {
		...
		@Override
		public void cancelled(String cancelled) {
	...
	public interface Delegate {
		...
		void cancelled(String cancelled);
