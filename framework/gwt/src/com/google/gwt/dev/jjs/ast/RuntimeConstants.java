...
public class RuntimeConstants {
	public static final String ASYNC_FRAGMENT_LOADER_BROWSER_LOADER = "AsyncFragmentLoader.BROWSER_LOADER";
	...
	public static final String CAST_HAS_JAVA_OBJECT_VIRTUAL_DISPATCH = "Cast.hasJavaObjectVirtualDispatch";

	public static final String CAST_THROW_CLASS_CAST_EXCEPTION_UNLESS_NULL = "Cast.throwClassCastExceptionUnlessNull";

	public static final String CLASS_CREATE_FOR_CLASS = "Class.createForClass";

	public static final String CLASS_CREATE_FOR_ANONYMOUS_CLASS = "Class.createForAnonymousClass";
	...
	public static final String COLLAPSED_PROPERTY_HOLDER_GET_PERMUTATION_ID = "CollapsedPropertyHolder.getPermutationId";
	...
	public static final String RUN_ASYNC_CODE_FOR_SPLIT_POINT_NUMBER = "RunAsyncCode.forSplitPointNumber";
