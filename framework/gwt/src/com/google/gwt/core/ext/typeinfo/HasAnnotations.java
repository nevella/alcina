...
public interface HasAnnotations {
	 ...
	 * list will include annotations on supertypes as well.
	 */
	Annotation[] getAnnotations();

	default <T extends Annotation> List<T>
			getAnnotations(Class<T> annotationClass) {
		return (List<T>) Arrays.stream(getAnnotations())
	 ...
	 * include any inherited annotations.
	 */
