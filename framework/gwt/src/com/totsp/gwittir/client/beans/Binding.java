...
public class Binding {
   ...
   // private static final Introspector INTROSPECTOR = Introspector.INSTANCE;
    ...
    public void resolveAllFeedback(){
    	if ((left != null) && (right != null)) {
...
//TODO - bug here i think
    ...
    private BindingInstance createBindingInstance(Bindable object,
        ...
        while (dotIndex != -1) {
            ...
            try {
                ...
                if (descriminator != null) {
                    ...
                    Object collectionOrArray = GwittirBridge.get().getProperty(object, pname)
                                                           .getAccessorMethod()
                                                           .invoke(object, null);
                    object = this.getDiscriminatedObject(collectionOrArray,
                            descriminator);
                } else {
                    object = (Bindable) GwittirBridge.get().getProperty(object, pname)
                                                    .getAccessorMethod()
                                                    .invoke(object, null);
                }
        ...
        instance.property =  GwittirBridge.get().getDescriptor(object)
                                        .getProperty(propertyName);
