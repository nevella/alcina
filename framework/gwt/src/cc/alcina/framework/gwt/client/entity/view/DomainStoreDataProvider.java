...
public class DomainStoreDataProvider<T extends Entity>
	...
	public HandlerRegistration
		...
		return handlerManager.addHandler(DataProviderChangeEvent.TYPE, handler);
	}
	...
	public void search() {
		...
		if (getLastSearchDefinition() != null
			...
			if (getLastSearchDefinition() != null && lastRange != null) {
				EntitySearchDefinition lastDefCopy = getLastSearchDefinition()
						.cloneObject();
				EntitySearchDefinition defCopy = searchDefinition.cloneObject();
