...
public interface ClientNotifications extends LogWriter {
    ...
    public abstract void setDialogAnimationEnabled(boolean dialogAnimationEnabled);

    public abstract void showDialog(String captionHTML, Widget captionWidget, String msg, MessageType messageType, List<Button> extraButtons);

    public abstract void showDialog(String captionHTML, Widget captionWidget, String msg, MessageType messageType, List<Button> extraButtons, String containerStyle);
    ...
    default Label showCodePopup(String popupText, Optional<String> extraClassName) {
    ...
    public static class Notification {
        ...
        public Notification withOncePerClientInstance(boolean oncePerClientInstance) {
            this.oncePerClientInstance = oncePerClientInstance;
            return this;
        }

        public Notification withShowBeforeUiInitComplete(boolean showBeforeUiInitComplete) {
