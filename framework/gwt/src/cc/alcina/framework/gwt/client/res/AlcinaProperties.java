...
public class AlcinaProperties {
    ...
    public static AlcinaProperties get() {
        AlcinaProperties singleton = Registry.checkSingleton(AlcinaProperties.class);
        if (singleton == null) {
    ...
    public static void put(Class<?> clazz, String key, String value) {
        String cKey = clazz == null ? key : CommonUtils.simpleClassName(clazz) + "." + key;
    ...
    public AlcinaProperties() {
        super();
        properties = AlcinaResources.INSTANCE == null ? new StringMap() : StringMap.fromPropertyString(AlcinaResources.INSTANCE.appProperties().getText());
    }
