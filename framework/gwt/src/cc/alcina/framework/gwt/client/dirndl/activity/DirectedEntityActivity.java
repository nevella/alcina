...
public class DirectedEntityActivity<EP extends EntityPlace, E extends Entity> extends DirectedActivity<EP> {
    ...
    public void setEntityNotFound(boolean entityNotFound) {
        ...
        propertyChangeSupport().firePropertyChange("entityNotFound", old_entityNotFound, entityNotFound);
    }
    ...
    public void setEntity(E entity) {
        ...
        this.entity = entity;
        propertyChangeSupport().firePropertyChange("entity", old_entity, entity);
    }
    ...
    private void onCreate(Entity e, Runnable postCreate) {
        if (place.fromId != 0 && place.fromClass != null) {
            ...
            Optional<Property> ownerReflector = Entity.Ownership.getOwnerReflectors(e.entityClass()).filter(r -> r.annotation(Association.class).implementationClass() == implementationClass).filter(Objects::nonNull).findFirst();
