 ...
 * <p>
 * If you set the width or height of the {@link DecoratedRelativePopupPanel},
 * you need to set the height and width of the middleCenter cell to 100% so that
 * the middleCenter cell takes up all of the available space. If you do not set
 * the width and height of the {@link DecoratedRelativePopupPanel}, it will wrap
...
public class DecoratedRelativePopupPanel extends RelativePopupPanel {
	 ...
	 */
	public DecoratedRelativePopupPanel(boolean autoHide) {
		this(autoHide, false);
	}
	 ...
	 */
	public DecoratedRelativePopupPanel(boolean autoHide, boolean modal) {
