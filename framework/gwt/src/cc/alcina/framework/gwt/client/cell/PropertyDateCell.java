 ...
 * means that the call to {@link ValueUpdater#update} will occur after
 * {@link #onBrowserEvent} has returned. Pressing the 'escape' key dismisses the
 * {@link DatePicker} popup without calling {@link ValueUpdater#update}.
 * 
 * <p>
 * Each {@link PropertyDateCell} has a unique {@link DatePicker} popup
 * associated with it; thus, if a single {@link PropertyDateCell} is used as the
 * cell for a column in a table, only one entry in that column will be editable
 * at a given time.
 * </p>
 */
