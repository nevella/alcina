...
public class SelectWithSearch<G, T> implements VisualFilterable, FocusHandler,
    ...
    public void setCloseOnPopdownFilterEmpty(
            boolean closeOnPopdownFilterEmpty) {
    ...
    public void setShowSelectedItemsInSearch(
            boolean showSelectedItemsInSearch) {
    ...
    protected void setPanelForPopupUI(
            DecoratedRelativePopupPanel panelForPopup) {
