...
public class SingleSelectionListBox<T> extends AbstractBoundWidget<T> implements HasFocus, SourcesFocusEvents,
    SourcesChangeEvents {
    public static final String VALUE_PROPERTY_NAME = "value";
    private static final Logger LOGGER = Logger.getLogger(SingleSelectionListBox.class.toString());
    ...
    public T getValue() {
        SingleSelectionListBox.LOGGER.log(Level.SPAM, "IsMultipleSelect. Returning collection", null);
