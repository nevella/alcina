...
public abstract class LoadObjectsFromRemotePlayer extends RunnableAsyncCallbackPlayer<LoadObjectsResponse, LoadObjectDataState> {
    ...
    @Override
    public void run() {
        LoadObjectsRequest request = Registry.impl(HandshakeConsortModel.class).getLoadObjectsRequest();
        loadObjects(request);
    }
