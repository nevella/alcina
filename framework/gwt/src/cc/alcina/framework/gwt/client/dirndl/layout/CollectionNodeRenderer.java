...
public class CollectionNodeRenderer extends DirectedNodeRenderer {
    ...
    public List<Widget> renderWithDefaults(Node node) {
        ...
        CollectionNodeRendererArgs args = node.annotation(CollectionNodeRendererArgs.class);
        ...
        for (Object object : collection) {
			 ...
			 */
            Class<? extends Object> modelClass = node.getResolver().resolveModel(object).getClass();
            if (args != null) {
                child.directed = CustomReflectorResolver.forParentAndValue(CollectionNodeRendererArgs.class, node, modelClass, args.value());
            } else {
                child.directed = CustomReflectorResolver.forParentAndValue(CollectionNodeRendererArgs.class, node, modelClass, Directed.Default.INSTANCE);
            }
