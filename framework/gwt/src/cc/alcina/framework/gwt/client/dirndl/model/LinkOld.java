...
import cc.alcina.framework.gwt.client.dirndl.model.LinkOld.LinkRendererPrimaryClassName;
...
public class LinkOld extends Model {
	...
	private Class<? extends ModelEvent> topicClass;
	...
	public Class<? extends ModelEvent> getTopicClass() {
		return topicClass;
	}
	...
	public LinkOld withActionRef(Class<? extends ActionRef> clazz) {
		return withPlace(new ActionRefPlace(clazz));
	}

	public LinkOld withClassName(String className) {
		this.className = className;
		return this;
	}

	public LinkOld withHref(String href) {
		this.href = href;
		return this;
	}

	public LinkOld withNewTab(boolean newTab) {
		this.newTab = newTab;
		return this;
	}
	...
	public LinkOld withPlace(BasePlace place) {
		this.place = place;
		return this;
	}

	public LinkOld withPrimaryAction(boolean primaryAction) {
		this.primaryAction = primaryAction;
		return this;
	}

	public LinkOld withRunnable(Runnable runnable) {
		this.runnable = runnable;
		return this;
	}

	public LinkOld withText(String text) {
		this.text = text;
		return this;
	}

	public LinkOld withTitle(String title) {
		this.title = title;
		return this;
	}

	public LinkOld withTopic(Class<? extends ModelEvent> topicClass) {
		this.topicClass = topicClass;
		return this;
	}

	public LinkOld withWithoutLink(boolean withoutLink) {
		this.withoutLink = withoutLink;
		return this;
	}
	...
	public static class LinkRenderer extends LeafNodeRenderer {
			...
			if (place == null) {
				...
				if (model.getTopicClass() != null) {
					rendered.addDomHandler(event -> {
						...
						ModelEvent.fire(context, model.getTopicClass(), null);
					}, ClickEvent.getType());
				}
				...
				if (place instanceof ActionRefPlace) {
					...
					if (emitsTopic.isPresent()
						...
						rendered.addDomHandler(event -> {
							Class<? extends ModelEvent> type = emitsTopic.get()
									.value();
							Context context = NodeEvent.Context
									.newTopicContext(event, node);
							ModelEvent.fire(context, type, null);
						}, ClickEvent.getType());
					}
				}
			}
		...
		private LinkOld model(Node node) {
			return (LinkOld) node.getModel();
		}
