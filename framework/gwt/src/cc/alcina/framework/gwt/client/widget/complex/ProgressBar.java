 ...
 * <li>.alcina-ProgressBar-shell .alcina-ProgressBar-bar { the actual progress
 * bar }</li>
 * <li>.alcina-ProgressBar-shell .alcina-ProgressBar-text { text on the bar }
 * </li>
 * <li>.alcina-ProgressBar-shell .alcina-ProgressBar-text-firstHalf { applied to
 * text when progress is less than 50 percent }</li>
 * <li>.alcina-ProgressBar-shell .alcina-ProgressBar-text-secondHalf { applied
