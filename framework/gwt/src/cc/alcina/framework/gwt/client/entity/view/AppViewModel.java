...
public class AppViewModel {
    ...
    public <T extends VersionableEntity> DomainStoreDataProvider<T> getDataProvider(Class<T> clazz) {
    ...
    protected <T extends VersionableEntity> DomainStoreDataProvider<T> createProvider(Class<T> clazz) {
