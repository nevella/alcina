...
public class ContentViewFactory {
    ...
    public ContentViewFactory additionalProvisional(
            Object additionalProvisional) {
    ...
    public ContentViewFactory editableFieldFilter(
            Predicate<String> editableFieldFilter) {
