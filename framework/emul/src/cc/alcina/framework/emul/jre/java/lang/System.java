...
public final class System {
	...
	public static void arraycopy(Object src, int srcOfs, Object dest,
		...
		checkArrayType(arrayTypeMatch(srcComp, destComp),
		 ...
		 */
		if (isTypeChecked() && !srcComp.isPrimitive()
	...
	/*
	 * Dummy implementation - but not that useful anyway -
	...
	/**
	 * Just used as a container for Logger.Level
	 */
	public interface Logger {
		public enum Level {
			 ...
			 * {@linkplain #getSeverity() severity} is
			 ...
			 * This level {@linkplain #getSeverity() severity} is {@code 400}.
			 */
			TRACE(400), // typically mapped to/from j.u.l.Level.FINER
			/**
			 * {@code DEBUG} level: usually used to log debug information
			 * traces. This level {@linkplain #getSeverity() severity} is
			 * {@code 500}.
			 */
			DEBUG(500), // typically mapped to/from
						// j.u.l.Level.FINEST/FINE/CONFIG
			/**
			 * {@code INFO} level: usually used to log information messages.
			 * This level {@linkplain #getSeverity() severity} is {@code 800}.
			 */
			INFO(800), // typically mapped to/from j.u.l.Level.INFO
			/**
			 * {@code WARNING} level: usually used to log warning messages. This
			 * level {@linkplain #getSeverity() severity} is {@code 900}.
			 */
			WARNING(900), // typically mapped to/from j.u.l.Level.WARNING
			/**
			 * {@code ERROR} level: usually used to log error messages. This
			 * level {@linkplain #getSeverity() severity} is {@code 1000}.
			 */
			...
			/**
			 * Returns the severity of this level. A higher severity means a
