...
public class Demo {
	public static void main(String[] args)
		...
		final WatchableFile file1 = new WatchableFile(
				new File(home + "/Downloads"));
		final WatchableFile file2 = new WatchableFile(
			...
			public void run() {
				for (;;) {
					...
					for (WatchEvent<?> event : key.pollEvents()) {
						...
						System.out.println("detected file system event: "
								+ ev.context() + " " + kind);
					}
					// Reset the key -- this step is critical to receive further
					// watch events.
