...
/**
 * <p>
 * A simple structured content browser - its initial application is as a help
 * content UI
 * <p>
 * Sketch
 * <ul>
...
public interface Feature_ContentBrowserModule extends Feature {
	/**
	 * The help area - header (including search, tree, contents/results)
	 */
	@Feature.Parent(Feature_ContentBrowserModule.class)
