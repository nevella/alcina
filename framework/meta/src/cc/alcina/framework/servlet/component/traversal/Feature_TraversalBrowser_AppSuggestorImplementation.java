...
@Feature.Parent(Feature_TraversalBrowser_PersistentSettings.class)
public interface Feature_TraversalBrowser_AppSuggestorImplementation
		extends Feature {
	/**
	 * <h2>Phase 1</h2>
	 * 
	...
	* - A full keyboard shortcuts list
	 ...
	 */
	@Feature.Type.Ref(Feature.Type.Ui_implementation.class)
	@Feature.Parent(Feature_TraversalBrowser_AppSuggestorImplementation.class)
