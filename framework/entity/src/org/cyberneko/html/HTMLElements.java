 ...
 * @author Ahmed Ashour
 * 
 * @version $Id$ (for jade: overriden to close P elts on start OL, P.
 *          tagbalancer here to help tracing
 */
public class HTMLElements {
	...
	public static final short LF = LEGEND + 1;

	public static final short LI = LF + 1;
	...
	public static final ElementList ELEMENTS = new ElementList();

	/** No such element. */
	public static final Element NO_SUCH_ELEMENT = new Element(UNKNOWN, "",
			Element.BLOCK, new short[] { HEAD, BODY }/* HTML */, null);
	//
	// Static initializer
	//
	/**
	...
	static {
		...
		ELEMENTS_ARRAY['B' - 'A'] = new Element[] {
				...
				new Element(BLOCKQUOTE, "BLOCKQUOTE", Element.BLOCK, BODY,
						new short[] { P }),
		...
		ELEMENTS_ARRAY['C' - 'A'] = new Element[] {
				...
				// COLGROUP - O (COL)*
				new Element(COLGROUP, "COLGROUP", 0, TABLE,
						new short[] { COL, COLGROUP }),
				// COMMENT
		...
		ELEMENTS_ARRAY['F' - 'A'] = new Element[] {
				...
				new Element(FORM, "FORM", Element.CONTAINER,
						new short[] { BODY, TD, P, DIV },
						new short[] { BUTTON }),
				// FRAME - O EMPTY
		...
		ELEMENTS_ARRAY['H' - 'A'] = new Element[] {
				...
				new Element(H1, "H1", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
				new Element(H2, "H2", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
				new Element(H3, "H3", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
				new Element(H4, "H4", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
				new Element(H5, "H5", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
				new Element(H6, "H6", Element.BLOCK, new short[] { BODY, A },
						new short[] { H1, H2, H3, H4, H5, H6, P }),
		...
		ELEMENTS_ARRAY['L' - 'A'] = new Element[] {
				...
				// LF
				new Element(LF, "LF", Element.EMPTY, BODY, null),
				// LI - O (%flow;)*
				new Element(LI, "LI", 0, new short[] { BODY, UL, OL },
						new short[] { LI, P }),
				// LINK - O EMPTY
		...
		ELEMENTS_ARRAY['M' - 'A'] = new Element[] {
				...
				// META - O EMPTY
				new Element(META, "META", Element.EMPTY, HEAD,
						new short[] { STYLE, TITLE }),
				// MULTICOL
		...
		ELEMENTS_ARRAY['N' - 'A'] = new Element[] {
				...
				// NOSCRIPT - - (%block;)+
				new Element(NOSCRIPT, "NOSCRIPT", 0, new short[] { BODY },
						null), };
		ELEMENTS_ARRAY['O' - 'A'] = new Element[] {
				...
				// OPTGROUP - - (OPTION)+
				new Element(OPTGROUP, "OPTGROUP", 0, SELECT,
						new short[] { OPTION }),
				// OPTION - O (#PCDATA)
				new Element(OPTION, "OPTION", 0, SELECT,
						new short[] { OPTION }), };
		ELEMENTS_ARRAY['P' - 'A'] = new Element[] {
				// P - O (%inline;)*
				new Element(P, "P", 0, BODY, new short[] { P }),
				// PARAM - O EMPTY
				new Element(PARAM, "PARAM", Element.EMPTY,
						new short[] { OBJECT, APPLET }, null),
				// PLAINTEXT
				new Element(PLAINTEXT, "PLAINTEXT", Element.SPECIAL, BODY,
						null),
		...
		ELEMENTS_ARRAY['R' - 'A'] = new Element[] {
				...
				// RT
				new Element(RT, "RT", Element.INLINE, RUBY,
						new short[] { RB, RP }),
				// RTC
		...
		ELEMENTS_ARRAY['S' - 'A'] = new Element[] {
				...
				// SCRIPT - - %Script;
				new Element(SCRIPT, "SCRIPT", Element.SPECIAL,
				...
				// STYLE - - %StyleSheet;
				new Element(STYLE, "STYLE", Element.SPECIAL,
						new short[] { HEAD, BODY },
						new short[] { STYLE, TITLE, META }),
				// SUB - - (%inline;)*
		...
		ELEMENTS_ARRAY['T' - 'A'] = new Element[] {
				...
				// TBODY+)
				new Element(TABLE, "TABLE", Element.BLOCK | Element.CONTAINER,
						BODY, null),
				// TBODY O O (TR)+
				new Element(TBODY, "TBODY", 0, TABLE,
						new short[] { THEAD, TD, TH, TR, COLGROUP }),
				// TD - O (%flow;)*
				new Element(TD, "TD", 0, TR, TABLE, new short[] { TD, TH }),
				// TEXTAREA - - (#PCDATA)
				new Element(TEXTAREA, "TEXTAREA", Element.SPECIAL, BODY, null),
				// TFOOT - O (TR)+
				new Element(TFOOT, "TFOOT", 0, TABLE,
						new short[] { THEAD, TBODY, TD, TH, TR }),
				// TH - O (%flow;)*
				new Element(TH, "TH", 0, TR, TABLE, new short[] { TD, TH }),
				// THEAD - O (TR)+
				new Element(THEAD, "THEAD", 0, TABLE, new short[] { COLGROUP }),
				// TITLE - - (#PCDATA) -(%head.misc;)
				new Element(TITLE, "TITLE", Element.SPECIAL,
						new short[] { HEAD, BODY }, null),
				// TR - O (TH|TD)+
				new Element(TR, "TR", Element.BLOCK, TABLE,
						new short[] { TD, TH, TR, COLGROUP }),
				// TT - - (%inline;)*
		...
		ELEMENTS_ARRAY['U' - 'A'] = new Element[] {
				...
				// UL - - (LI)+
				new Element(UL, "UL", Element.BLOCK, BODY,
						new short[] { P }), };
	...
	public static class Element {
		 ...
		 *            Informational flags
		 * @param parent
		 *            Natural closing parent name.
		 * @param closes
		 *            List of elements this element can close.
		 */
		public Element(short code, String name, int flags, short parent,
				short bounds, short[] closes) {
		 ...
		 *            Informational flags
		 * @param parents
		 *            Natural closing parent names.
		 * @param closes
		 *            List of elements this element can close.
		 */
		public Element(short code, String name, int flags, short[] parents,
				short bounds, short[] closes) {
			this.code = code;
			this.name = name;
			this.flags = flags;
