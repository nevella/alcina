...
public class ResourceUtilities {
    ...
    public static StringMap classPathStringExistenceMap(Class clazz, String path) {
        return StringMap.fromStringList(readClassPathResourceAsString(clazz, path));
    }

    public static StringMap classPathStringMap(Class clazz, String path) {
        return StringMap.fromPropertyString(readClassPathResourceAsString(clazz, path));
    }

    public static <T> T copyBeanProperties(Object srcBean, T tgtBean, Class methodFilterAnnotation, boolean cloneCollections) {
        return copyBeanProperties(srcBean, tgtBean, methodFilterAnnotation, cloneCollections, new ArrayList<String>());
    }

    public static <T> T copyBeanProperties(Object srcBean, T tgtBean, Class methodFilterAnnotation, boolean cloneCollections, Collection<String> ignorePropertyNames) {
        for (PropertyDescriptor targetDescriptor : SEUtilities.getPropertyDescriptorsSortedByName(tgtBean.getClass())) {
            if (ignorePropertyNames.contains(targetDescriptor.getName())) {
                continue;
            }
            PropertyDescriptor sourceDescriptor = SEUtilities.getPropertyDescriptorByName(srcBean.getClass(), targetDescriptor.getName());
    ...
    public static <T> T fieldwiseClone(T t, boolean withTransients, boolean withCollectionProjection) {
        try {
            T instance = newInstanceForCopy(t);
            return fieldwiseCopy(t, instance, withTransients, withCollectionProjection);
        } catch (Exception e) {
            throw new WrappedRuntimeException(e);
        }
    }

    public static <T> T fieldwiseCopy(T t, T toInstance, boolean withTransients, boolean withShallowCopiedCollections) {
        return fieldwiseCopy(t, toInstance, withTransients, withShallowCopiedCollections, null);
    }

    public static <T> T fieldwiseCopy(T t, T toInstance, boolean withTransients, boolean withShallowCopiedCollections, Set<String> ignoreFieldNames) {
        try {
            ...
            while (c != Object.class) {
                ...
                for (Field field : fields) {
                    ...
                    if (ignoreFieldNames != null && ignoreFieldNames.contains(field.getName())) {
                        continue;
                    }
            ...
            for (Field field : allFields) {
                ...
                if (project) {
                    if (value instanceof Map) {
                        ...
                        Collection newCollection = (Collection) newInstanceForCopy(collection);
                        if (newCollection instanceof LiSet) {
                            // handled by newInstanceForCopy/clone
                        } else {
                            newCollection.addAll(collection);
                        }
                        Preconditions.checkState(collection.size() == newCollection.size());
                        value = newCollection;
                    }
                }
    ...
    public static String get(String propertyName) {
        return get(StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE).getCallerClass(), propertyName);
    }
    ...
    public static synchronized String getBundledString(Class clazz, String propertyName) {
        String namespacedKey = (clazz == null) ? propertyName : GraphProjection.classSimpleName(clazz) + "." + propertyName;
        return cache.computeIfAbsent(namespacedKey, k -> ResourceUtilities.getBundledString0(clazz, propertyName));
    }

    public static synchronized String getBundledString0(Class clazz, String propertyName) {
        String namespacedKey = (clazz == null) ? propertyName : GraphProjection.classSimpleName(clazz) + "." + propertyName;
        ...
        b = ResourceBundle.getBundle(clazz.getPackage().getName() + ".Bundle", Locale.getDefault(), clazz.getClassLoader());
    ...
    public static boolean is(String propertyName) {
        return is(StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE).getCallerClass(), propertyName);
    }
    ...
    public static Document loadHtmlDocumentFromInputStream(InputStream is, String charset, boolean upperCaseTags) throws Exception {
        ...
        if (charset == null) {
            ...
            isrc = new InputSource(new InputStreamReader(new ByteArrayInputStream(bs), charset));
        }
    ...
    public static Document loadHtmlDocumentFromString(String s, boolean upperCaseTags) throws Exception {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        OutputStreamWriter osw = new OutputStreamWriter(baos, "UTF-8");
        osw.write(s);
        osw.close();
        return loadHtmlDocumentFromInputStream(new ByteArrayInputStream(baos.toByteArray()), "UTF-8", upperCaseTags);
    }
    ...
    public static DomDoc loadXmlDocFromHtmlString(String html, boolean upperCaseTags) {
        try {
    ...
    public static String readClassPathResourceAsStringPreferFile(Class clazz, String path, String filePath) {
    ...
    public static String readRelativeResource(String path) {
        return readClassPathResourceAsString(StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE).getCallerClass(), path);
    }
    ...
    public static byte[] readUrlAsBytesWithPost(String strUrl, String postBody, StringMap headers) throws Exception {
        return new SimpleQuery(strUrl).withPostBody(postBody).withHeaders(headers).asBytes();
    }

    public static byte[] readUrlAsBytesWithPut(String strUrl, String body, StringMap headers) throws Exception {
        return new SimpleQuery(strUrl).asPut().withBody(body).withHeaders(headers).asBytes();
    }
    ...
    public static String readUrlAsString(String strUrl, String charset, StringMap headers) throws Exception {
        InputStream in = null;
    ...
    public static String readUrlAsStringWithPost(String strUrl, String postBody, StringMap headers) throws Exception {
        byte[] bytes = readUrlAsBytesWithPost(strUrl, postBody, headers);
        return new String(bytes, StandardCharsets.UTF_8);
    }

    public static String readUrlAsStringWithPut(String strUrl, String body, StringMap headers) throws Exception {
    ...
    public static void registerCustomProperties(InputStream ios) {
        try {
            ...
            if (ios != null) {
                boolean debugRegistration = customProperties != null && customProperties.containsKey("ResourceUtilities.debugPropertyRegistration") && is(ResourceUtilities.class, "debugPropertyRegistration");
    ...
    public static void registerCustomProperty(String key, String value) {
        ResourceUtilities.registerCustomProperties(new ByteArrayInputStream(Ax.format("%s=%s", key, value).getBytes()));
    }
    ...
    public static void setField(Object object, String fieldPath, Object newValue) throws Exception {
    ...
    public static void writeStreamToStream(InputStream in, OutputStream os, boolean keepOutputOpen) throws IOException {
    ...
    public static void writeStringToFileNoUpdate(String content, String path) throws Exception {
    ...
    private static <T> T newInstanceForCopy(T t) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        if (t instanceof LiSet) {
            return (T) ((LiSet) t).clone();
        }
        Constructor<T> constructor = null;
        try {
            constructor = (Constructor<T>) t.getClass().getConstructor(new Class[0]);
        } catch (NoSuchMethodException e) {
            constructor = (Constructor<T>) t.getClass().getDeclaredConstructor(new Class[0]);
        }
    ...
    public static class SimpleQuery {
        ...
        public byte[] asBytes() throws Exception {
            ...
            if (queryStringParameters != null) {
                ...
                strUrl += queryStringParameters.entrySet().stream().map(e -> {
                    return Ax.format("%s=%s", e.getKey(), UrlComponentEncoder.get().encode(e.getValue()));
            ...
            try {
                ...
                connection.setDoInput(true);
                connection.setUseCaches(false);
                if (hostnameVerifier != null && connection instanceof HttpsURLConnection) {
                ...
                if (responseCode >= 400) {
                    throw new StatusCodeException(responseCode, connection.getResponseMessage());
                }
                if (decodeGz) {
        ...
        public SimpleQuery withBasicAuthentication(String username, String password) {
            String auth = Ax.format("%s:%s", username, password);
            headers.put("Authorization", Ax.format("Basic %s", Base64.getEncoder().encodeToString(auth.getBytes(StandardCharsets.UTF_8))));
            return this;
        }
        ...
        public SimpleQuery withHostnameVerifier(HostnameVerifier hostnameVerifier) {
        ...
        public SimpleQuery withPostBodyQueryParameters(StringMap queryParameters) {
            asPost = true;
        ...
        public SimpleQuery withQueryStringParameters(StringMap queryStringParameters) {
        ...
        private byte[] maybeDecodeGzip(byte[] input) throws IOException {
            if ("gzip".equals(connection.getHeaderField("content-encoding"))) {
                return readStreamToByteArray(new GZIPInputStream(new ByteArrayInputStream(input)));
            } else {
                return input;
            }
        }
