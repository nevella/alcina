...
public class NaiveTransformPersistenceQueue implements TransformPersistenceQueue {
    ...
    @Override
    public DomainTransformLayerWrapper submit(TransformPersistenceToken persistenceToken) {
        if (AppPersistenceBase.isTest() && !TransformCommit.isCommitTestTransforms()) {
            DomainTransformLayerWrapper wrapper = new DomainTransformLayerWrapper(null);
