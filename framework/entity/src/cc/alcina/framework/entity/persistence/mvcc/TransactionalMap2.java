 ...
 *   
 */
public abstract class TransactionalMap2<K, V> extends AbstractMap<K, V>
	...
	//
	// private Map<K, V> nonTransactional;
	//
	// private Map<K, Key<V>> transactional;
	//
	// public TransactionalMap2(Class<K> keyClass, Class<V> valueClass) {
	...
	// }
	//
	// private TransactionalMap2<K, V>.Layer ensureLayer() {
	...
	// ConcurrentSkipListMap<Transaction, Layer> nonMergedTransactionLayers =
	...
	// }
	//
	// class Key<V> extends MvccObjectVersions<V> {
	// @Override
	// protected boolean accessibleFromOtherTransactions(V t) {
	// return false;
	// }
	//
	// @Override
	// protected void copyObjectFields(V fromObject, V toObject) {
	...
	//
	// @Override
	// protected void register(V object) {
	// // TODO Auto-generated method stub
	// }
	// }
	//
	...
	// }
	//
	// class SingleValued extends AbstractMap<K, V> {
	// @Override
	// public Set<Entry<K, V>> entrySet() {
	// // TODO Auto-generated method stub
	// return null;
	...
	// Iterator<Entry<K, V>>[] iteratorArray = (Iterator<Entry<K, V>>[])
	// iterators
	// .toArray(new Iterator[iterators.size()]);
	// MultiIterator<Entry<K, V>> layerIterator = new MultiIterator<Entry<K,
	// V>>(
	// false,
	...
	// }
	// if (!TransactionalMap2.this.containsKey(next.getKey())) {
