...
public class EncryptionUtils {
    ...
    public static String MD5(List<byte[]> byties) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        MessageDigest md;
        md = MessageDigest.getInstance("MD5");
    ...
    private GenericObjectPool<MessageDigest> sha1DigestPool = new GenericObjectPool<MessageDigest>(new MessageDigestFactory());
    ...
    private class MessageDigestFactory extends BasePooledObjectFactory<MessageDigest> {
