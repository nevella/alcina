...
public class StandardProjectionFilterFactories {
    ...
    public static class ProjectionDomainFilterFactory implements RegistryFactory<CollectionProjectionFilter> {
    ...
    public static class ProjectionFieldFilterFactory implements RegistryFactory<PermissibleFieldFilter> {
