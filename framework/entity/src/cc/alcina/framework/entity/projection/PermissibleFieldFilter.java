...
public class PermissibleFieldFilter implements GraphProjectionFieldFilter {
    ...
    CachingMap<Class, ObjectPermissions> objectPermissionLookup = new CachingMap<Class, ObjectPermissions>(clazz -> (ObjectPermissions) clazz.getAnnotation(ObjectPermissions.class));

    public PermissibleFieldFilter() {
        disabledPerThreadPerObjectPermissionsInstance = disabledPerThreadPerObjectPermissionsThreadLocal.get();
    }
    ...
    public boolean permitField(Field field, Set<Field> perObjectPermissionFields, Class forClass) {
        try {
            ...
            PropertyPermissions pp = GraphProjection.getPropertyPermission(field);
