 ...
 */
abstract class AbstractNonSunWatchKey implements WatchKey {
	/**
	...
	protected AbstractNonSunWatchKey(Path dir,
			AbstractNonSunWatchService watcher) {
	...
	final void signalEvent(WatchEvent.Kind<?> kind, Object context) {
		...
		synchronized (this) {
			...
			// non-repeated event
			Event<Object> ev = new Event<>((WatchEvent.Kind<Object>) kind,
					context);
			if (isModify) {
