 ...
 */
/**
 * Package changed to help with classpath issues
 */
public class UnixCrypt extends Object {
	...
	private static final int cov_2char[] = { 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33,
			...
			0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x61,
	 ...
	 * the encryption engine in lots of different ways. If you are generating a
	 * new encryption then this value should be randomised.
	 * 
	 * @param original The password to be encrypted.
	 * 
	 * @return A string consisting of the 2-character salt followed by the
