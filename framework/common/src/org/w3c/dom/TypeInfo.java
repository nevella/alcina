 ...
 * associated with the document. The type is a pair of a namespace URI and name
 * properties, and depends on the document's schema.
 * <p>
 * If the document's schema is an XML DTD
 * [<a href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0</a>], the
 * values are computed as follows:
 * <ul>
 * <li>If this type is referenced from an <code>Attr</code> node,
 * <code>typeNamespace</code> is <code>"http://www.w3.org/TR/REC-xml"</code> and
 * <code>typeName</code> represents the <b>[attribute type]</b> property in the
 ...
 * </li>
 * <li>If this type is referenced from an <code>Element</code> node,
 * <code>typeNamespace</code> and <code>typeName</code> are <code>null</code>.
 * </li>
 * </ul>
 * <p>
 ...
 * Part 1</a>] , the values are computed as follows using the
 * post-schema-validation infoset contributions (also called PSVI
 * contributions):
 * <ul>
 * <li>If the <b>[validity]</b> property exists AND is <em>"invalid"</em> or
 * <em>"notKnown"</em>: the {target namespace} and {name} properties of the
 * declared type if available, otherwise <code>null</code>.
 * <p >
 ...
 * not to provide type information if validity is not valid.</li>
 ...
 * properties of the <b>[member type definition]</b> property;</li>
 * <li>Otherwise, expose the namespace and local name of the corresponding
 * anonymous type name.</li>
 * </ol>
 * </li>
 * <li>If the <b>[type definition]</b> property exists:
 * <ol>
 * <li>If {name} is not absent, then expose {name} and {target namespace}
 * properties of the <b>[type definition]</b> property;</li>
 * <li>Otherwise, expose the namespace and local name of the corresponding
 * anonymous type name.</li>
 * </ol>
 * </li>
 ...
 * <ol>
 * <li>If it is false, then expose <b>[member type definition name]</b> and
 * <b>[member type definition namespace]</b> properties;</li>
 * <li>Otherwise, expose the namespace and local name of the corresponding
 * anonymous type name.</li>
 * </ol>
 * </li>
 ...
 * definition namespace]</b> properties;</li>
 * <li>Otherwise, expose the namespace and local name of the corresponding
 * anonymous type name.</li>
 * </ol>
 * </li>
...
public interface TypeInfo {
	 ...
	 * [<a href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema
	 * Part 1</a>] , this constant represents the <a href=
	 * 'http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#element-list'>list</a>.
	 * <br>
