 ...
 * . Each implemented <code>DOMImplementationSource</code> object is listed in
...
public interface DOMImplementationSource {
	 ...
	 *            example, the string
	 *            <code>"XML 3.0 Traversal +Events 2.0"</code> will request a
	 *            DOM implementation that supports the module "XML" for its 3.0
	 *            version, a module that support of the "Traversal" module for
