 ...
 * node. If the filter says to accept the node, the traversal logic returns it;
...
public interface NodeFilter {
	...
	/**
	 * Accept the node. Navigation methods defined for <code>NodeIterator</code>
	 * or <code>TreeWalker</code> will return this node.
	 */
	public static final short FILTER_ACCEPT = 1;

	/**
	 * Reject the node. Navigation methods defined for <code>NodeIterator</code>
	 * or <code>TreeWalker</code> will not return this node. For
	 * <code>TreeWalker</code>, the children of this node will also be rejected.
	 * <code>NodeIterators</code> treat this as a synonym for
	 ...
	 * <code>NodeIterator</code> or <code>TreeWalker</code> will not return this
	 * node. For both <code>NodeIterator</code> and <code>TreeWalker</code>, the
	 ...
	 * children of other nodes, they do not appear when traversing over the
	 * document tree.
	 */
	 ...
	 * <code>TreeWalker</code> or <code>NodeIterator</code>. This function will
	 * be called by the implementation of <code>TreeWalker</code> and
	 * <code>NodeIterator</code>; it is not normally called directly from user
	 * code. (Though you could do so if you wanted to use the same filter to
