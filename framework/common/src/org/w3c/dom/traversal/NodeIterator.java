...
/**
 * <code>Iterators</code> are used to step through a set of nodes, e.g. the set
...
public interface NodeIterator {
	/**
	 * The root node of the <code>NodeIterator</code>, as specified when it was
	 * created.
	 */
	public Node getRoot();
	 ...
	 * currently the only situation where <code>NodeIterators</code> may reject
	 * a complete subtree rather than skipping individual nodes. <br>
	 * <br>
	 ...
	 * <code>expandEntityReferences</code> to true when creating the iterator.
	 * To produce a view of the document that has entity reference nodes but no
	 * entity expansion, use the <code>whatToShow</code> flags to show the
	 ...
	 * iterator in the set. After a <code>NodeIterator</code> is created, the
	 * first call to <code>nextNode()</code> returns the first node in the set.
	 * 
