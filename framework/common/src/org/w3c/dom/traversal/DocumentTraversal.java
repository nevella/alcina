...
public interface DocumentTraversal {
	 ...
	 *            flag specifies which node types may appear in the logical view
	 *            of the tree presented by the iterator. See the description of
	 ...
	 *            <code>TreeWalker</code>. The <code>whatToShow</code> flags and
	 *            the <code>NodeFilter</code> are not considered when setting
	 *            this value; any node type will be accepted as the
	 *            <code>root</code>. The <code>currentNode</code> of the
	 *            <code>TreeWalker</code> is initialized to this node, whether
	 *            or not it is visible. The <code>root</code> functions as a
	 *            stopping point for traversal methods that look upward in the
	 *            document structure, such as <code>parentNode</code> and
	 *            nextNode. The <code>root</code> must not be <code>null</code>.
	 * @param whatToShowThis
	 *            flag specifies which node types may appear in the logical view
	 *            of the tree presented by the tree-walker. See the description
	 *            of <code>NodeFilter</code> for the set of possible SHOW_
	 ...
	 *            <code>EntityReference</code> nodes are not presented in the
	 *            logical view.
