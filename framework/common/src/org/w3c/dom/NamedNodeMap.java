 ...
 * also be accessed by an ordinal index, but this is simply to allow convenient
 * enumeration of the contents of a <code>NamedNodeMap</code>, and does not
...
public interface NamedNodeMap {
	 ...
	 * Replacing a node by itself has no effect. <br>
	 ...
	 * <code>localName</code>. If a node with that namespace URI and that local
	 * name is already present in this map, it is replaced by the new one.
	 * Replacing a node by itself has no effect. <br>
	 * Per [<a href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML
	 * Namespaces</a>] , applications must use the value null as the
	 * namespaceURI parameter for methods if they wish to have no namespace.
