 ...
 * XML document. Note that this models the entity itself <em>not</em> the entity
 * declaration.
 * <p>
 ...
 * <a href='http://www.w3.org/TR/2004/REC-xml-20040204#intern-replacement'>
 ...
 * related <code>EntityReference</code> node has to be replaced in the structure
 * model by a clone of the <code>Entity</code>'s contents, and then the desired
 * changes must be made to each of those clones instead. <code>Entity</code>
 * nodes and all their descendants are readonly.
 * <p>
 * An <code>Entity</code> node does not have any parent.
 * <p >
 * <b>Note:</b> If the entity contains an unbound namespace prefix, the
 * <code>namespaceURI</code> of the corresponding node in the
 * <code>Entity</code> node subtree is <code>null</code>. The same is true for
 * <code>EntityReference</code> nodes that refer to this entity, when they are
 * created using the <code>createEntityReference</code> method of the
