...
public interface Range {
	 ...
	 * 
	 * @param refNodeThe
	 *            <code>refNode</code> value. This parameter must be different
	 *            from <code>null</code>.
	 * @param offsetThe
	 ...
	 * 
	 * @param toStartIf
	 *            TRUE, collapses the Range onto its start; if FALSE, collapses
	 *            it onto its end.
	 * @exception DOMException
	 *                INVALID_STATE_ERR: Raised if <code>detach()</code> has
	 *                already been invoked on this object.
	 ...
	 *            <code>Range</code> on which this current <code>Range</code> is
	 *            compared to.
	 ...
	 * result in a <code>DOMException</code> being thrown with an error code of
