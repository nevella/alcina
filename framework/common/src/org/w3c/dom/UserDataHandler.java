...
public interface UserDataHandler {
	 ...
	 * The node is deleted.
	 * <p >
	 * <b>Note:</b> This may not be supported or may not be reliable in certain
	 * environments, such as Java, where the implementation has no real control
	 ...
	 * <code>UserDataHandler</code>. The effect of throwing exceptions from the
	 ...
	 *            deleted.
	 * @param dst
	 *            Specifies the node newly created if any, or <code>null</code>.
	 */
