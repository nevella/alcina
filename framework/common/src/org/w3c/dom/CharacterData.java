 ...
 * the interface from it. All <code>offsets</code> in this interface start from
 * <code>0</code>.
 * <p>
 * As explained in the <code>DOMString</code> interface, text strings in the DOM
...
public interface CharacterData extends Node {
	 ...
	 * implementation limits may mean that the entirety of a node's data may not
	 * fit into a single <code>DOMString</code>. In such cases, the user may
	 * call <code>substringData</code> to retrieve the data in appropriately
	 * sized pieces.
	 * 
	 ...
	 * and the <code>substringData</code> method below. This may have the value
