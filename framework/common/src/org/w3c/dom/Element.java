 ...
 * <code>Node</code> interface attribute <code>attributes</code> may be used to
 * retrieve the set of all attributes for an element. There are methods on the
 * <code>Element</code> interface to retrieve either an <code>Attr</code> object
 * by name or an attribute value by name. In XML, where an attribute value may
 * contain entity references, an <code>Attr</code> object should be retrieved to
 ...
 * values, methods to directly access an attribute value can safely be used as a
 * convenience.
 * <p >
 * <b>Note:</b> In DOM Level 2, the method <code>normalize</code> is inherited
 * from the <code>Node</code> interface where it was moved.
 * <p>
 * See also the
...
public interface Element extends Node {
	 ...
	 * <code>setAttributeNode</code> to assign it as the value of an attribute.
	 * <br>
	 * Per [<a href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML
	 * Namespaces</a>] , applications must use the value <code>null</code> as
	 * the <code>namespaceURI</code> parameter for methods if they wish to have
