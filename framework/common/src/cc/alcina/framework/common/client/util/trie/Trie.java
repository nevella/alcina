...
public interface Trie<K, V> extends SortedMap<K, V> {
	/**
	 * Returns a view of this {@link Trie} of all elements that are prefixed by
	 * the given key.
	 * 
	 * <p>
	 ...
	 * 'Andreas', 'Andrea', 'Andres', and 'Anatole', then a lookup of 'And'
	 * would return 'Andreas', 'Andrea', and 'Andres'.
	 */
	public SortedMap<K, V> prefixMap(K prefix);

	/**
	 * Returns the {@link Map.Entry} whose key is closest in a bitwise XOR
	 * metric to the given key. This is NOT lexicographic closeness. For
	 ...
	 * 'L', because the XOR distance between D &amp; L is smaller than the XOR
	 * distance between D &amp; H.
	 * 
	 * @return The {@link Map.Entry} whose key is closest in a bitwise XOR
	 *         metric to the provided key.
	 */
	 ...
	 * continue calling select for each entry (traversing in order of XOR
	 * closeness, NOT lexicographically) until the cursor returns
	 * {@link Decision#EXIT}.
	 * 
	 * <p>
