...
public class AnnotationLocation {
    ...
    public AnnotationLocation(Class clazz, Property property, Resolver resolver) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AnnotationLocation) {
            ...
            return property == o.property && classLocation == o.classLocation && Objects.equals(resolver, o.resolver);
        } else {
            return false;
        }
    }
    ...
    public AnnotationLocation parent() {
        ...
        if (classLocation.getSuperclass() != null) {
            return new AnnotationLocation(classLocation.getSuperclass(), null, resolver);
        }
        return null;
    }
    ...
    public String toString() {
        if (property != null) {
            String declaringPrefix = property.getDefiningType() == classLocation ? "" : Ax.format("(%s)", classLocation.getSimpleName());
    ...
    public static abstract class Resolver {
        ...
        private static MultikeyMap<Annotation> resolvedCache = new UnsortedMultikeyMap<>(2);
        ...
        public synchronized <A extends Annotation> A resolveAnnotation(Class<A> annotationClass, AnnotationLocation location) {
            Annotation ensure = resolvedCache.ensure(() -> resolveAnnotation0(annotationClass, location), location, annotationClass);
            return (A) ensure;
        }

        protected <A extends Annotation> Annotation resolveAnnotation0(Class<A> annotationClass, AnnotationLocation location) {
