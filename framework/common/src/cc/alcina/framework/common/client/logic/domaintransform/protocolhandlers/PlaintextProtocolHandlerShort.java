...
public class PlaintextProtocolHandlerShort implements DTRProtocolHandler {
    ...
    public void appendTo(DomainTransformEvent domainTransformEvent, StringBuffer sb) {
        ...
        sb.append("\n");
        appendString((domainTransformEvent.getObjectClass() == null ? domainTransformEvent.getObjectClassName() : domainTransformEvent.getObjectClass().getName()), sb);
        sb.append(",");
        sb.append(SimpleStringParser.toStringNoInfo(domainTransformEvent.getObjectId()));
        sb.append(",");
        sb.append(SimpleStringParser.toStringNoInfo(domainTransformEvent.getObjectLocalId()));
        sb.append(",");
        ...
        appendString(ns, sb);
        sb.append("\n");
        appendString(domainTransformEvent.getValueClass() == null ? domainTransformEvent.getValueClassName() : domainTransformEvent.getValueClass().getName(), sb);
        sb.append(",");
        sb.append(SimpleStringParser.toStringNoInfo(domainTransformEvent.getValueId()));
        sb.append(",");
        sb.append(SimpleStringParser.toStringNoInfo(domainTransformEvent.getValueLocalId()));
        sb.append(",");
    ...
    public String deserialize(String serializedEvents, List<DomainTransformEvent> events, int maxCount) {
        ...
        int i = 0;
        String s;
        while ((s = asyncParser.read(getDomainTransformEventMarker(), getDomainTransformEventMarker(), false, false)) != null) {
    ...
    public void maybeDeserializeStringLookup(SimpleStringParser p) {
        ...
        if (reverseStringLookup == null) {
            ...
            for (String value : s.split("\n")) {
                reverseStringLookup.put(String.valueOf(reverseStringLookup.size()), value);
            }
        }
    }
