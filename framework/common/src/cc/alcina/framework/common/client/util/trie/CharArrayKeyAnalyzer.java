...
public class CharArrayKeyAnalyzer extends AbstractKeyAnalyzer<char[]>
	 ...
	 */
	public static final CharArrayKeyAnalyzer CHAR = new CharArrayKeyAnalyzer(
			Character.SIZE);

	/**
	 * A {@link CharArrayKeyAnalyzer} that uses only the lower 8 bits of a
	 * {@code char}.
	 */
	public static final CharArrayKeyAnalyzer BYTE = new CharArrayKeyAnalyzer(
			Byte.SIZE);
