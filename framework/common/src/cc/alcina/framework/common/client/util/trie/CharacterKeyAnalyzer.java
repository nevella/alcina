...
public class CharacterKeyAnalyzer extends AbstractKeyAnalyzer<Character>
	 ...
	 */
	public static final CharacterKeyAnalyzer CHAR = new CharacterKeyAnalyzer(
			Character.SIZE);

	/**
	 * A {@link CharacterKeyAnalyzer} that uses only the lower 8bits of a
	 * {@code char}.
	 */
	public static final CharacterKeyAnalyzer BYTE = new CharacterKeyAnalyzer(
			Byte.SIZE);
