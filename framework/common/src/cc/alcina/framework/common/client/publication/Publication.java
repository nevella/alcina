...
public abstract class Publication extends Entity<Publication> implements HasOwner, HasIUser, SearchResult {
    ...
    public Definition getDefinition() {
        definition = TransformManager.resolveMaybeDeserialize(definition, this.definitionSerialized, null, Reflections.forName(definitionClassName));
    ...
    public void setDefinition(Definition definition) {
        ...
        propertyChangeSupport().firePropertyChange("definition", old_definition, definition);
    }
    ...
    public void setDefinitionClassName(String definitionClassName) {
        ...
        propertyChangeSupport().firePropertyChange("definitionClassName", old_definitionClassName, definitionClassName);
    }
    ...
    public void setDefinitionDescription(String definitionDescription) {
        ...
        propertyChangeSupport().firePropertyChange("definitionDescription", old_definitionDescription, definitionDescription);
    }
    ...
    public void setDefinitionSerialized(String definitionSerialized) {
        ...
        propertyChangeSupport().firePropertyChange("definitionSerialized", old_definitionSerialized, definitionSerialized);
    }
    ...
    public void setDefinitionSignature(String definitionSignature) {
        ...
        propertyChangeSupport().firePropertyChange("definitionSignature", old_definitionSignature, definitionSignature);
    }
    ...
    public void setMimeMessageId(String mimeMessageId) {
        ...
        propertyChangeSupport().firePropertyChange("mimeMessageId", old_mimeMessageId, mimeMessageId);
    }

    public abstract void setOriginalPublication(Publication originalPublication);

    public void setPublicationDate(Date publicationDate) {
        Date old_publicationDate = this.publicationDate;
        this.publicationDate = publicationDate;
        propertyChangeSupport().firePropertyChange("publicationDate", old_publicationDate, publicationDate);
    }

    public void setPublicationType(String publicationType) {
        String old_publicationType = this.publicationType;
        this.publicationType = publicationType;
        propertyChangeSupport().firePropertyChange("publicationType", old_publicationType, publicationType);
    }
    ...
    public void setPublicationUid(String publicationUid) {
        ...
        propertyChangeSupport().firePropertyChange("publicationUid", old_publicationUid, publicationUid);
    }
    ...
    public void setSerializedPublication(String serializedPublication) {
        ...
        propertyChangeSupport().firePropertyChange("serializedPublication", old_serializedPublication, serializedPublication);
    }
