...
public abstract class ContentDeliveryType extends ExtensibleEnum {
    ...
    public static class ContentDeliveryType_DOWNLOAD_PREVIEW
    ...
    public static class ContentDeliveryType_DOWNLOAD_ATTACHMENT
            extends ContentDeliveryType {
        @Override
        public String serializedForm() {
            return "DOWNLOAD";
    ...
    public static class ContentDeliveryType_PERMALINK
            extends ContentDeliveryType {
        @Override
    ...
    public static class ContentDeliveryType_LOCAL_FILESYSTEM
            extends ContentDeliveryType {
        @Override
        public boolean isRepublishable() {
            return true;
    ...
    public static class ContentDeliveryType_SEND_TO_REPOSITORY
            extends ContentDeliveryType {
    }
