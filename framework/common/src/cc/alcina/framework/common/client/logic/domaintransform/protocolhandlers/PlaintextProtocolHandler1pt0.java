...
public class PlaintextProtocolHandler1pt0 implements DTRProtocolHandler {
    ...
    public void appendTo(DomainTransformEvent domainTransformEvent, StringBuffer sb) {
        ...
        sb.append(",");
        sb.append(SimpleStringParser20.longToGwtDoublesToString(domainTransformEvent.getObjectId()));
        sb.append(",");
        sb.append(SimpleStringParser20.longToGwtDoublesToString(domainTransformEvent.getObjectLocalId()));
        sb.append(newlineTab);
        sb.append(PARAMS);
        ...
        sb.append(",");
        sb.append(domainTransformEvent.getUtcDate() == null ? System.currentTimeMillis() : domainTransformEvent.getUtcDate().getTime());
        sb.append(newlineTab);
        sb.append(STRING_VALUE);
        sb.append(ns);
        sb.append(newlineTab);
        sb.append(TGT);
        sb.append(domainTransformEvent.getValueClass() == null ? null : domainTransformEvent.getValueClass().getName());
        sb.append(",");
        sb.append(SimpleStringParser20.longToGwtDoublesToString(domainTransformEvent.getValueId()));
        sb.append(",");
        sb.append(SimpleStringParser20.longToGwtDoublesToString(domainTransformEvent.getValueLocalId()));
        sb.append("\n");
    }
    ...
    public List<DomainTransformEvent> deserialize(String serializedEvents) {
        ...
        String s;
        while ((s = p.read(getDomainTransformEventMarker(), getDomainTransformEventMarker(), true, false)) != null) {
