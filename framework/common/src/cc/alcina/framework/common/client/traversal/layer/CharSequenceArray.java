...
public class CharSequenceArray
	...
	/**
	 * This is the array containing the text of interest. This array should
	 * never be modified; it is available only for efficiency.
	 */
	public char[] array;
	 ...
	 */
	public CharSequenceArray(char[] array, int offset, int count) {
		this.array = array;
		this.offset = offset;
		this.count = count;
		partialReturn = false;
	...
	public CharSequence subSequence(int start, int end) {
		...
		CharSequenceArray segment = new CharSequenceArray();
