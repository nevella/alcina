 ...
 * TODO - 
 */
public interface TreeResolver<A> {
	public A resolve(PropertyReflector property, A child);

	public static class DefaultResolver<A> {
		private A leafValue;

		private DefaultResolver<A> childResolver;
		...
		public DefaultResolver(DefaultResolver<A> childResolver) {
		 ...
		 */
		public DefaultResolver(Location propertyLocation, A leafValue) {
