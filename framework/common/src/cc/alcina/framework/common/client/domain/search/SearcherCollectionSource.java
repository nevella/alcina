...
public interface SearcherCollectionSource {
    ...
    <T> Optional<Stream<T>> getSourceStreamFor(Class<T> clazz, SearchDefinition def);
    ...
    public static class SearcherCollectionSource_Domain implements SearcherCollectionSource {
        ...
        @Override
        public <T> Optional<Stream<T>> getSourceStreamFor(Class<T> clazz, SearchDefinition def) {
