...
public class DateUtils {
    ...
    protected int ageInDays0(Date date) {
        return (int) (date == null ? 0 : (System.currentTimeMillis() - date.getTime()) / TimeConstants.ONE_DAY_MS);
    }

    protected int ageInMinutes0(Date date) {
        return (int) (date == null ? 0 : (System.currentTimeMillis() - date.getTime()) / TimeConstants.ONE_MINUTE_MS);
    }
}
