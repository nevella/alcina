...
/**
 * The {@link KeyAnalyzer} provides bit-level access to keys for the
 * {@link PatriciaTrie}.
 */
public interface KeyAnalyzer<K> extends Comparator<K> {
	/**
	 * Returned by {@link #bitIndex(Object, Object)} if a key's bits were all
	 * zero (0).
	 */
	public static final int NULL_BIT_KEY = -1;

	/**
	 * Returned by {@link #bitIndex(Object, Object)} if a the bits of two keys
	 * were all equal.
	 */
	public static final int EQUAL_BIT_KEY = -2;

	/**
	 * Returned by {@link #bitIndex(Object, Object)} if a keys indices are out
	 * of bounds.
	 */
