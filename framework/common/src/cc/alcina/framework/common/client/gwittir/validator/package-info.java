/**
 * <p>
 * All these validators should have their error messages reworked to use the
 * Alicna i18n framework - e.g.:
 * </p>
 * <p>
 * <i>(in superclass)</i>
 * </p>
 ...
 * 		params = new Object[0];
 * 	}
 * 	String msg = TextProvider.get().getUiObjectText(getClass(), errCode,
 * 			enMsg);
