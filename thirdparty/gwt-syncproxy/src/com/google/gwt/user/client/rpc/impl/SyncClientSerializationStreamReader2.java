 ...
 */
public final class SyncClientSerializationStreamReader2 extends AbstractSerializationStreamReader2 {
    ...
    public void doDeserialize(AsyncCallback postPrepareCallback) {
        ...
        AsyncDeserializerDev asyncDeserializerDev = new AsyncDeserializerDev(this);
    ...
    public void prepareToRead(String encoded) throws SerializationException {
        ...
        if (getVersion() < SERIALIZATION_STREAM_MIN_VERSION || getVersion() > SERIALIZATION_STREAM_MAX_VERSION) {
            throw new IncompatibleRemoteServiceException("Got version " + getVersion() + ", expected version between "
        ...
        if (((getFlags() & FLAG_INCREMENTAL_DESERIALIZABLE) == 0 || getVersion() != SERIALIZATION_STREAM_VERSION)) {
            throw new IncompatibleRemoteServiceException("requires incremental deserializable rpc");
        }
        if (!areFlagsValid()) {
    ...
    public long readLong() {
        return Base64Utils.longFromBase64(((JsStringLiteral) decoder.getValues().get(--index)).getValue());
    }
    ...
    private static class RpcDecoder extends JsVisitor {
        ...
        public boolean visit(JsArrayLiteral x, JsContext ctx) {
            ...
            default:
                throw new RuntimeException(
                        "Unexpected array in RPC payload. The string table has " + "already started.");
            }
        }
        ...
        enum State {
            EXPECTING_PAYLOAD_BEGIN, EXPECTING_TYPE_TABLE, IN_TYPE_TABLE, EXPECTING_STRING_TABLE, IN_STRING_TABLE,
            EXPECTING_END
        }
    }
    ...
    class AsyncDeserializerDev {
        ...
        public AsyncDeserializerDev(SyncClientSerializationStreamReader2 reader) {
            this.reader = reader;
            try {
                mkmClazz = Class.forName("cc.alcina.framework.common.client.util.MultikeyMap");
            } catch (Exception e) {
        ...
        private boolean deserializeProperties() throws SerializationException {
            ...
            for (; sliceCount != 0 && idx2 < size; idx2++) {
                ...
                // serverserwriter
                boolean collectionOrMap = instance != null && (instance instanceof Collection || instance instanceof Map
                        || mkmClazz.isAssignableFrom(instance.getClass()));
                if (collectionOrMap ^ (phase == PhaseDev.DESERIALIZE_COLLECTION_RUN)) {
                    continue;
                }
                if (idx2 == 0) {
        ...
        private boolean instantiateEmptyObjects() throws SerializationException {
            ...
            for (; sliceCount != 0 && idx2 < typeTableLength; idx2++) {
                ...
                Object instance = reader.serializer.instantiate(reader, typeSignature);
    ...
    enum PhaseDev {
        INSTATIATE_EMPTY_SETUP, INSTATIATE_EMPTY_RUN, DESERIALIZE_NON_COLLECTION_PRE, DESERIALIZE_NON_COLLECTION_RUN,
