...
class SyncSerializer implements Serializer {
    ...
    private Object deserializeImpl(SerializationStreamReader stream, Class<?> customSerializer, Class<?> instanceClass,
            Object instance) throws NoSuchMethodException, IllegalArgumentException, IllegalAccessException,
            InvocationTargetException, SerializationException, ClassNotFoundException {
        if (customSerializer != null) {
            deserializeWithCustomFieldDeserializer(stream, customSerializer, instanceClass, instance);
    ...
    private void deserializeWithCustomFieldDeserializer(SerializationStreamReader stream, Class<?> customSerializer,
     ...
     * @throws SerializationException
     */
    private Object deserializeArray(SerializationStreamReader stream, Class<?> instanceClass, Object instance)
            throws SerializationException {
        assert (instanceClass.isArray());
    ...
    private void deserializeClass(SerializationStreamReader stream, Class<?> instanceClass, Object instance)
            throws SerializationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException,
        ...
        if (serializationPolicy.shouldDeserializeFields(superClass)) {
            deserializeImpl(stream, SerializabilityUtil.hasCustomFieldSerializer(superClass), superClass, instance);
        }
    }

    public Object deserializeValue(SerializationStreamReader stream, Class<?> type) throws SerializationException {
    ...
    public String getSerializationSignature(Class<?> clazz) {
        return SerializabilityUtil.getSerializationSignature(clazz, serializationPolicy);
    }

    private Object instantiate(SerializationStreamReader stream, Class<?> customSerializer, Class<?> instanceClass)
    ...
    public Object instantiate(SerializationStreamReader stream, String typeSignature) throws SerializationException {
        ...
        SerializedInstanceReference serializedInstRef = SerializabilityUtil
                .decodeSerializedInstanceReference(typeSignature);
        try {
            Class<?> instanceClass = getClassCached(serializedInstRef.getName());
