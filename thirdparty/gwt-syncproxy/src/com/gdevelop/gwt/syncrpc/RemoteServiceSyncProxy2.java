...
import com.google.gwt.user.client.rpc.impl.AbstractSerializationStreamReader2;
import com.google.gwt.user.client.rpc.impl.AbstractSerializationStreamWriter;
import com.google.gwt.user.client.rpc.impl.SyncClientSerializationStreamReader2;
 ...
 */
public class RemoteServiceSyncProxy2 implements SerializationStreamFactory {
    ...
    public RemoteServiceSyncProxy2(String moduleBaseURL, String remoteServiceRelativePath,
    ...
    @Override
    public AbstractSerializationStreamReader2 createStreamReader(String encoded) throws SerializationException {
    ...
    private static StreamReaderConstructor streamReaderConstructor = new StreamReaderConstructor() {
        @Override
        public AbstractSerializationStreamReader2 createStreamReader(String encoded,
                SerializationPolicy serializationPolicy) throws SerializationException {
            SyncClientSerializationStreamReader2 reader = new SyncClientSerializationStreamReader2(
                    new SyncSerializer(serializationPolicy));
    ...
    @Override
    public AbstractSerializationStreamWriter createStreamWriter() {
        // SyncSerializer serializer = new SyncSerializer(serializationPolicy);
        // ClientSerializationStreamWriter streamWriter = new
        // ClientSerializationStreamWriter(serializer, moduleBaseURL,
    ...
    public Object doInvoke(RequestCallbackAdapter.ResponseReader responseReader, String requestData) throws Throwable {
        ...
        synchronized (RemoteServiceSyncProxy2.class) {
    ...
    public static void setStreamReaderConstructor(StreamReaderConstructor streamReaderConstructor) {
        RemoteServiceSyncProxy2.streamReaderConstructor = streamReaderConstructor;
    }
}
