	...
	public void execute() throws BuildException {
		...
		try {
			setProperty(Constants.ALCINA_HOME_ABS,
					new File(PackageUtils.translatePath(getProperty(Constants.ALCINA_HOME)))
							.getCanonicalPath());
			setProperty(Constants.DEPLOY_JBOSS_DIR_ABS,
					new File(PackageUtils.translatePath(getProperty(Constants.DEPLOY_JBOSS_DIR)))
							.getCanonicalPath());
			setProperty(Constants.GWT_SDK_DIR_ABS,
					new File(PackageUtils.translatePath(getProperty(Constants.GWT_SDK_DIR)))
							.getCanonicalPath());
