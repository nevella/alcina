...
import com.google.gwt.user.client.rpc.impl.AsyncDeserializer;
...
public final class ClientSerializationStreamReader extends
	...
	private JavaScriptObject stringTable;

	private JsArrayInteger typeTable;
	...
	public void doDeserialize(AsyncCallback postPrepareCallback) {
		...
		Scheduler.get().scheduleIncremental(new AsyncDeserializer(this));
	}
