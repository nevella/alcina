...
public class RemoteComponentServeLocalHandler extends AbstractHandler {
	@SuppressWarnings("unused")
	private RemoteComponentRemote devConsoleRemote;

	public RemoteComponentServeLocalHandler(RemoteComponentRemote devConsoleRemote) {
