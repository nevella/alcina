...
public class TaskGenerateGwtTypemodelJar
		extends ServerTask<TaskGenerateGwtTypemodelJar> {
	String outPath = "/tmp/gwt-typemodel";

	@Override
	public void performAction0(TaskGenerateGwtTypemodelJar task)
			throws Exception {
		String path = "/private/var/local/root/apdm/git/2022.3/Software/alcina/lib/framework/gwt/gwt-dev.jar";
