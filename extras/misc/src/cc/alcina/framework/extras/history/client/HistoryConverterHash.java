...
/**
 * {@link HistoryConverter} implementation for browsers without HTML5 pushState
 * support and therefore expect the history token inside the hash.
 * 
 * <p>
 * Incoming links like <code>http://www.barop.de/impressum</code> are redirected
 * to <code>http://www.barop.de/#impressum</code>.
 * </p>
 * 
...
public class HistoryConverterHash implements HistoryConverter {
	private static final Logger LOG = Logger
			.getLogger(HistoryConverterHash.class.getName());
