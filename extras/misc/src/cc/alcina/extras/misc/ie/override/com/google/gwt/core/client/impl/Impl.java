...
public final class Impl {
	...
	private static Map<Integer, Boolean> entriesWithoutExits = new LinkedHashMap<Integer, Boolean>();
	...
	private static Object entry0(Object jsFunction, Object thisObj,
		...
		if (GWT.getUncaughtExceptionHandler() == null) {
			...
			entriesWithoutExits.put(entryDepth-1,initialEntry);
			// Can't handle any exceptions, let them percolate normally
			Object result = apply(jsFunction, thisObj, arguments);
			entriesWithoutExits.remove(entryDepth-1);
			exit(initialEntry);
			return result;
		} else {
			boolean initialEntry = enter();
			try {
				/*
				 * Always invoke the UCE if we have one so that the exception
				 * never percolates up to the browser's event loop, even in a
				 * reentrant situation.
				 */
				/*
