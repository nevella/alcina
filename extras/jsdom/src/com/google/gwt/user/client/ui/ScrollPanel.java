...
public class ScrollPanel extends SimplePanel implements SourcesScrollEvents,
	...
	public int getMaximumHorizontalScrollPosition() {
		return ScrollImpl.get()
				.getMaximumHorizontalScrollPosition(getScrollableElement());
	}

	@Override
	public int getMaximumVerticalScrollPosition() {
		return getScrollableElement().getScrollHeight()
				- getScrollableElement().getClientHeight();
	}

	@Override
	public int getMinimumHorizontalScrollPosition() {
		return ScrollImpl.get()
				.getMinimumHorizontalScrollPosition(getScrollableElement());
	}
	...
	public void setAlwaysShowScrollBars(boolean alwaysShow) {
		getScrollableElement().getStyle()
				.setOverflow(alwaysShow ? Overflow.SCROLL : Overflow.AUTO);
	}
