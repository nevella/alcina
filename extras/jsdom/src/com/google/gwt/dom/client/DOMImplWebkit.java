...
class DOMImplWebkit extends DOMImplStandardBase {
  ...
  /**
   * Webkit events sometimes target the Text_Dom Node_Dom inside of the Element_Dom instead
   * of the Element_Dom itself, so we need to get the parent of the Text_Dom Node_Dom.
   */
  @Override
