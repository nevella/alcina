...
public final class HTMLInputElementSelectionRangeRecord {
	...
	public boolean equals(Object obj) {
		if (obj instanceof HTMLInputElementSelectionRangeRecord) {
			HTMLInputElementSelectionRangeRecord o = (HTMLInputElementSelectionRangeRecord) obj;
			populateNodeIds();
			o.populateNodeIds();
	...
	public HTMLInputElementSelectionRangeRecord copy() {
		HTMLInputElementSelectionRangeRecord copy = new HTMLInputElementSelectionRangeRecord();
		copy.nodeId = nodeId;
